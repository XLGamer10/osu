...
namespace osu.Game.Rulesets.Osu.Difficulty.Evaluators.Aim
{
    public static class SnapAimEvaluator
    {
        ...
        /// </list>
        /// </summary>
        public static double EvaluateDifficultyOf(DifficultyHitObject current, bool withSliderTravelDistance, bool withCheesability, OsuDifficultyConstants tuning)
        {
            ...
            {
                double sliderBonus = osuCurrObj.SliderBonusDistance / osuCurrObj.SliderTravelTime;
        ...
        private static double vectorAngleRepetition(OsuDifficultyHitObject current, OsuDifficultyHitObject previous, OsuDifficultyConstants tuning)
        {
            ...
            double baseNerf = 1 - tuning.SnapAimMaxRepetitionNerf * CalcAngleAcuteness(lastAngle) * angleDifferenceAdjusted;
