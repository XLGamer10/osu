...
namespace osu.Game.Rulesets.Osu.Difficulty
{
    public class OsuPerformanceCalculator : PerformanceCalculator
    {
        ...
        private double computeAccuracyValue(ScoreInfo score, OsuDifficultyAttributes attributes)
        {
            ...
            double accuracyDifficulty = DiffUtils.Pow(1.57905, overallDifficulty) * 2;
            accuracyDifficulty = DiffUtils.Pow(accuracyDifficulty, 1.3);
            ...
            if (amountHitObjectsWithAccuracy > 2000)
                accuracyValue *= DiffUtils.Pow(2000.0 / amountHitObjectsWithAccuracy, 0.075);
        ...
        private double calculateComboBasedEstimatedMissCount(OsuDifficultyAttributes attributes)
        {
            ...
            if (usingClassicSliderAccuracy)
            {
                ...
                double likelyMissedSliderendPortion = 0.04 + 0.06 * DiffUtils.Pow(Math.Min(attributes.AimTopWeightedSliderFactor, 1), 2);
        ...
        private double inferenceSkillBayesian(double objects, double imperfects, double objectDifficulty, double difficultObjects)
        {
